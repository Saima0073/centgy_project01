...
{
	/// <summary>
	/// Summary description for shgn_gp_gp_ILUS_ET_GP_BENEFECIARY.
	/// </summary>
	public partial class shgn_gp_gp_ILUS_ET_GP_BENEFECIARY  : SHMA.CodeVision.Presentation.GroupBase
	{
