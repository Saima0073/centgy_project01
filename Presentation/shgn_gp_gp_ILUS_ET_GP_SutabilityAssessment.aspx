...
<head>
	...
	<iframe ALIGN="top" id="questFrame" FRAMEBORDER="0" MARGINWIDTH="0" width="100%" height="550" name="MedicalDetail" src="../Presentation/SuitabilityAssessment_Page.aspx?pid=0&amp;<%=ClientParams%>" style="mso-linked-frame:auto"  scrolling="yes">
	...
	<iframe ALIGN="top" FRAMEBORDER="0" MARGINWIDTH="0" width="100%" height="50" name="Assessment_Button.aspx" src="../Presentation/Assessment_Button.aspx?lfid=0&amp;<%=ClientParams%>" style="mso-linked-frame:auto"  scrolling="No">
	</BODY>
</html>
