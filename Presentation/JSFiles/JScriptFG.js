...
function callEvent(eventType, arg, argValue)
{
    ...
    if (eventType == 'New')
        ...
        if (eventType == 'Delete') {
            ...
            getField("_CustomEvent1").onclick();
        }
        else {
            getField("_CustomEvent").onclick();
        }
...
function setTempValues() {
    try {
        document.getElementById('ddlUSE_TYPE').selectedIndex = 1;
        document.getElementById('txtAGNTCODE').value = 0;
        document.getElementById('txtUSE_USERID').value = 0;
        document.getElementById('txtUSE_NAME').value = 'a';
    } catch (e) {
...
function clearTempValues() {
    try {
        document.getElementById('ddlUSE_TYPE').selectedIndex =0;
        document.getElementById('txtAGNTCODE').value = '';
        document.getElementById('txtUSE_USERID').value = '';
        document.getElementById('txtUSE_NAME').value = '';
    } catch (e) {
...
function checkAndGetTextBoxObject(index, rowType, fieldName) {
    ...
    {
        preFix = 'txtNew';
        return document.getElementById(ctlprefix + 'EntryGrid' + '__' + 'ctl' + index + '_' + preFix + fieldName);
    }
    else
    {
        preFix = 'txt';
