...
<HTML>
  ...
  //          {
  //              YN = document.getElementById('EntryGrid__ctl' + (j+1) + '_ddlNewUCN_DEFAULT').value;
		//		if(YN=='Y')
		//			counter++;
		//	}
		...
		//}
            function beforeSave() {
                ...
                for (j = 1; j <= totalRecords - 1; j++) {
                    YN = document.getElementById('EntryGrid__ctl' + (j + 1) + '_ddlUCN_DEFAULT').value;
                    if (YN == 'Y')
                        counter++;
                }
                ...
                NewDefault = document.getElementById('EntryGrid__ctl' + (totalRecords + 1) + '_ddlNewUCN_DEFAULT').value;
                if (NewDefault == "Y") {
                    counter++;
                }
                if ((counter) > 1) {
