...
<%@ Page Language="c#" CodeBehind="shgn_ts_se_tblscreen_ILUS_ET_TB_PLANDETAILS.aspx.cs"
    AutoEventWireup="True" Inherits="SHAB.Presentation.shgn_ts_se_tblscreen_ILUS_ET_TB_PLANDETAILS" %>
...
<body onload="setBuiltinRiderFields();setSizeOfWindow();">
    ...
    <table class="RIDER_TABLE" id="riderTable">
        ...
        <tr>
            <td>
                <shma:DataGrid ID="EntryGrid" runat="server" HeaderStyle-CssClass="GridHeader" AutoGenerateColumns="False"
                    ShowFooter="<%#ShowFooter%>" SelectedItemStyle-CssClass="GridSelRow">
                    <HeaderStyle CssClass="GridHeader"></HeaderStyle>
                    <ItemStyle Font-Size="Smaller" Font-Names="Arial" BorderWidth="3px" BorderStyle="None"
                        CssClass="ListRowItem"></ItemStyle>
                    <AlternatingItemStyle CssClass="ListRowAlt"></AlternatingItemStyle>
                    <SelectedItemStyle CssClass="GridSelRow"></SelectedItemStyle>
                    <Columns>
                        <asp:TemplateColumn>
                            <HeaderTemplate>
                                <asp:CheckBox ID="chkSelectAll" runat="server" Style="width: 0" Visible="False">
                                </asp:CheckBox></HeaderTemplate>
                            <ItemTemplate>
                                <shma:TextBox ID="txtPPR_SUMASSURED_ENABLED" Style="width: 0" runat="server" BaseType="Character"></shma:TextBox><shma:TextBox
                                    ID="txtPPR_BENEFITTERM_ENABLED" Style="width: 0" runat="server" BaseType="Character"></shma:TextBox><shma:TextBox
                                        ID="txtNPR_EDUNITS_ENABLED" Style="width: 0" runat="server" BaseType="Character"></shma:TextBox><shma:TextBox
                                            ID="txtPPR_COMMLOADING_ENABLED" Style="width: 0" runat="server" BaseType="Character"></shma:TextBox><shma:TextBox
                                                ID="txtMinThresholdValue" Style="width: 0" runat="server" BaseType="Character"></shma:TextBox><shma:TextBox
                                                    ID="txtMaxThresholdValue" Style="width: 0" runat="server" BaseType="Character"></shma:TextBox><shma:TextBox
                                                        ID="lblNP1_PROPOSAL" Style="width: 0" Text='<%# DataBinder.Eval(Container, "DataItem.NP1_PROPOSAL") %>'
                                                        runat="server" BaseType="Character"></shma:TextBox><shma:TextBox ID="lblNP2_SETNO"
                                                            Style="width: 0" Text='<%# DataBinder.Eval(Container, "DataItem.NP2_SETNO") %>'
                                                            runat="server" BaseType="Number" Precision="0"></shma:TextBox><shma:TextBox ID="lblNPR_BASICFLAG"
                                                                Style="width: 0" Text='<%# DataBinder.Eval(Container, "DataItem.NPR_BASICFLAG") %>'
                                                                runat="server" BaseType="Character"></shma:TextBox><shma:TextBox ID="txtPPR_PRODCD"
                                                                    runat="server" Width='0.0pc' Text='<%#DataBinder.Eval(Container, "DataItem.PPR_PRODCD")%>'
                                                                    ReadOnly="true" BaseType="Character"></shma:TextBox><asp:CheckBox ID="chkDelete"
                                                                        runat="server" Visible="false"></asp:CheckBox>
                            </ItemTemplate>
                            <FooterTemplate>
                                <shma:TextBox ID="lblNewNP1_PROPOSAL" Style="width: 0" runat="server" BaseType="Character"></shma:TextBox><shma:TextBox
                                    ID="lblNewNP2_SETNO" Style="width: 0" runat="server" BaseType="Number" Precision="0"></shma:TextBox><shma:TextBox
                                        ID="lblNewNPR_BASICFLAG" Style="width: 0" runat="server" BaseType="Character"></shma:TextBox>
                            </FooterTemplate>
                        </asp:TemplateColumn>
                        ...
                        <asp:TemplateColumn HeaderText="Rider">
                            <ItemTemplate>
                                <shma:TextBox ID="txtPPR_DESCR" runat="server" Width='20.0pc' Text='' ReadOnly="true"
                                    MaxLength="3" BaseType="Character" CssClass="DisplayOnly"></shma:TextBox>
                            </ItemTemplate>
                            <FooterTemplate>
                            </FooterTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="Benefit Amount">
                            <ItemTemplate>
                                <shma:TextBox ID="txtNPR_SUMASSURED" runat="server" Width='7.0pc' Text='<%#DataBinder.Eval(Container, "DataItem.NPR_SUMASSURED")%>'
                                    MaxLength="15" CssClass="RequiredField" BaseType="Number" SubType="Currency"
                                    Precision="0">
                                </shma:TextBox>
                                <asp:CompareValidator ID="cfvNPR_SUMASSURED" runat="server" ControlToValidate="txtNPR_SUMASSURED"
                                    Operator="DataTypeCheck" Type="Currency" ErrorMessage="Number Format is Incorrect "
                                    Display="Dynamic"></asp:CompareValidator>
                                <asp:RequiredFieldValidator ID="rfvNPR_SUMASSURED" runat="server" Precision="0" ErrorMessage="Required"
                                    ControlToValidate="txtNPR_SUMASSURED" Display="Dynamic"></asp:RequiredFieldValidator>
                            </ItemTemplate>
                            <FooterTemplate>
                                <shma:TextBox ID="txtNewNPR_SUMASSURED" runat="server" Width='6.0pc' MaxLength="15"
                                    CssClass="RequiredField" BaseType="Number" SubType="Currency" Precision="0"></shma:TextBox>
                                <asp:CompareValidator ID="cfvNewNPR_SUMASSURED" runat="server" ControlToValidate="txtNewNPR_SUMASSURED"
                                    Operator="DataTypeCheck" Type="Double" ErrorMessage="Number Format is Incorrect "
                                    Display="Dynamic"></asp:CompareValidator>
                                <shma:PeeredRequiredFieldValidator ID="prfvNewNPR_SUMASSURED" runat="server" Precision="0"
                                    ErrorMessage="Required" ControlToValidate="txtNewNPR_SUMASSURED" ControlsToCheck="chkNewNPR_SELECTED"
                                    Display="Dynamic"></shma:PeeredRequiredFieldValidator>
                            </FooterTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="Term">
                            <ItemTemplate>
                                <shma:TextBox ID="txtNPR_BENEFITTERM" Width='3.0pc' runat="server" Text='<%#DataBinder.Eval(Container, "DataItem.NPR_BENEFITTERM")%>'
                                    MaxLength="2" CssClass="RequiredField" BaseType="Number" Precision="0">
                                </shma:TextBox>
                                <asp:CompareValidator ID="cfvNPR_BENEFITTERM" runat="server" ControlToValidate="txtNPR_BENEFITTERM"
                                    Operator="DataTypeCheck" Type="Double" ErrorMessage="Number Format is Incorrect "
                                    Display="Dynamic"></asp:CompareValidator>
                                <asp:RequiredFieldValidator ID="rfvNPR_BENEFITTERM" runat="server" Precision="0"
                                    ErrorMessage="Required" ControlToValidate="txtNPR_BENEFITTERM" Display="Dynamic"></asp:RequiredFieldValidator>
                            </ItemTemplate>
                            <FooterTemplate>
                                <shma:TextBox ID="txtNewNPR_BENEFITTERM" Width='3.0pc' runat="server" MaxLength="2"
                                ...
                                <asp:CompareValidator ID="cfvNewNPR_BENEFITTERM" runat="server" ControlToValidate="txtNewNPR_BENEFITTERM"
                                    Operator="DataTypeCheck" Type="Double" ErrorMessage="Number Format is Incorrect "
                                    Display="Dynamic"></asp:CompareValidator>
                                <shma:PeeredRequiredFieldValidator ID="prfvNewNPR_BENEFITTERM" runat="server" Precision="0"
                                    ErrorMessage="Required" ControlToValidate="txtNewNPR_BENEFITTERM" ControlsToCheck="chkNewNPR_SELECTED"
                                    Display="Dynamic"></shma:PeeredRequiredFieldValidator>
                            </FooterTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="Contribution">
                            <ItemTemplate>
                                <shma:TextBox ID="txtNPR_PREMIUM" runat="server" Width='7.0pc' Text='<%#DataBinder.Eval(Container, "DataItem.NPR_PREMIUM")%>'
                                    ReadOnly="true" MaxLength="15" BaseType="Number" SubType="Currency" Precision="2"
                                    CssClass="DisplayOnly"> </shma:TextBox>
                                <asp:CompareValidator ID="cfvNPR_PREMIUM" runat="server" ControlToValidate="txtNPR_PREMIUM"
                                    Operator="DataTypeCheck" Type="Currency" ErrorMessage="Number Format is Incorrect "
                                    Display="Dynamic"></asp:CompareValidator>
                            </ItemTemplate>
                            <FooterTemplate>
                                <shma:TextBox ID="txtNewNPR_PREMIUM" runat="server" Width='7.0pc' ReadOnly="true"
                                    MaxLength="15" BaseType="Number" SubType="Currency" Precision="2"></shma:TextBox>
                                <asp:CompareValidator ID="cfvNewNPR_PREMIUM" runat="server" ControlToValidate="txtNewNPR_PREMIUM"
                                    Operator="DataTypeCheck" Type="Currency" ErrorMessage="Number Format is Incorrect "
                                    Display="Dynamic"></asp:CompareValidator>
                                <shma:PeeredRequiredFieldValidator ID="prfvNewNPR_EDUNITS" runat="server" Precision="0"
                                    ErrorMessage="Required" ControlToValidate="txtNewNPR_EDUNITS" ControlsToCheck="chkNewNPR_SELECTED"
                                    Display="Dynamic"></shma:PeeredRequiredFieldValidator>
                            </FooterTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="%age">
                            <ItemTemplate>
                                <shma:TextBox ID="txtNPR_EDUNITS" runat="server" Width='3.0pc' Text='<%#DataBinder.Eval(Container, "DataItem.NPR_EDUNITS")%>'
                                    MaxLength="3" CssClass="RequiredField" BaseType="Number" Precision="0">
                                </shma:TextBox>
                                <asp:CompareValidator ID="cfvNPR_EDUNITS" runat="server" ControlToValidate="txtNPR_EDUNITS"
                                    Operator="DataTypeCheck" Type="Double" ErrorMessage="Number Format is Incorrect "
                                    Display="Dynamic"></asp:CompareValidator>
                                <asp:RequiredFieldValidator ID="rfvNPR_EDUNITS" runat="server" Precision="0" ErrorMessage="Required"
                                    ControlToValidate="txtNPR_EDUNITS" Display="Dynamic"></asp:RequiredFieldValidator>
                            </ItemTemplate>
                            <FooterTemplate>
                        ...
                        <asp:TemplateColumn HeaderText="Option">
                            <ItemTemplate>
                                <shma:DropDownList ID="ddlNPR_COMMLOADING" runat="server" BlankValue="True" DataTextField="desc_f"
                                    DataValueField="csd_type" Width="10.0pc" CssClass="RequiredField">
                                </shma:DropDownList>
                                <asp:RequiredFieldValidator ID="rfvNPR_COMMLOADING" Enabled="False" runat="server"
                                    ErrorMessage="Required" ControlToValidate="ddlNPR_COMMLOADING" Display="Dynamic"></asp:RequiredFieldValidator>
                            </ItemTemplate>
                            <FooterTemplate>
                                <shma:DropDownList ID="ddlNewNPR_COMMLOADING" runat="server" BlankValue="True" DataTextField="desc_f"
                                    DataValueField="csd_type" Width="10.0pc" CssClass="RequiredField">
                                </shma:DropDownList>
                                <shma:PeeredRequiredFieldValidator ID="prfvNewNPR_COMMLOADING" runat="server" ErrorMessage="Required"
                                    ControlToValidate="ddlNewNPR_COMMLOADING" ControlsToCheck="chkNewNPR_SELECTED"
                                    Display="Dynamic"></shma:PeeredRequiredFieldValidator>
                            </FooterTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="">
                            <ItemTemplate>
                                <shma:TextBox ID="txtFaceCurrency" runat="server" Width='0.0pc' MaxLength="2" CssClass="DisplayOnly"
                                    BaseType="Character">
                                </shma:TextBox>
                            </ItemTemplate>
                            <FooterTemplate>
                        ...
                        <asp:TemplateColumn HeaderText="">
                            <ItemTemplate>
                                <shma:TextBox ID="txtPremiumCurrency" runat="server" Width='0.0pc' MaxLength="2"
                                    CssClass="DisplayOnly" BaseType="Character">
                                </shma:TextBox>
                            </ItemTemplate>
                            <FooterTemplate>
                            </FooterTemplate>
            ...
            <tr>
                <td class="button2TD" align="right">
                    ...
                    <a href="#" class="button2" onclick="allToggle();">Select All</a> <a href="javascript: self.close ()"
                        class="button2">&nbsp;&nbsp;&nbsp;Close&nbsp;&nbsp;&nbsp;</a>
                </td>
            </tr>
            <tr class="form_heading">
                <td height="20" colspan="4" align="center">
                    <asp:TextBox ID="txtModifiedRows" Style="z-index: 103; left: 496px; position: absolute;
                        top: 80px" runat="server" Height="12px" Width="0px"></asp:TextBox>
                    <asp:TextBox ID="txtOrgCode" Style="z-index: 102; left: 664px; position: absolute;
                        top: 208px" runat="server" Width="0px"></asp:TextBox>
                    ...
                    <input type="hidden" name="PkColumns" value="NP1_PROPOSAL,NP2_SETNO,PPR_PRODCD">
                    <input type="hidden" name="conditionCols" value="NPR_SUMASSURED,NPR_BENEFITTERM,NPR_EDUNITS,NPR_COMMLOADING">
                    <input type="hidden" name="conditionVars" value="ddlNPR_SELECTED">
                    <input type="hidden" name="conditionVals" value="ddlNPR_SELECTED=='Y'">
                </td>
            </tr>
    </table>
    </form>
