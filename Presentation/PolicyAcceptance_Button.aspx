...
<script language="javascript">
	...
	function callSave1()
	{
		...
		var propStr = parent.frames[0].getField("txtNP1_PROPOSAL").value;
		var retVal = executeClass("ace.Ace_General,CheckForDeclineProposal,'" + propStr + "'");
		if (retVal == "Declined") {
		    alert('Propsal has been Declined');
		    return;
		}
		if(parent.frames[0].validateBeforeDecision() == false)
		{
			return;
		}
