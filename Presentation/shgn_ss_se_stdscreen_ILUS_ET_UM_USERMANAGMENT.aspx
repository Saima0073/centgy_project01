...
<HTML>
	<HEAD>
		...
		{				
            ...
            {
                 myForm.ddlUSE_ACTIVE.selectedIndex =2;
            }
	...
	<body>
        ...
        <asp:ScriptManager runat="server">
            ...
            <asp:UpdatePanel runat="server" ID="rp_Up1">
            <ContentTemplate>
			...
			<INPUT style="WIDTH: 0px" id="_CustomEvent" value="Button" type="button" name="_CustomEvent" causesvalidation="true"
				runat="server" onserverclick="_CustomEvent_ServerClick">
                <INPUT style="WIDTH: 0px" id="_CustomEvent1" value="Button" type="button" name="_CustomEvent" causesvalidation="false"
				runat="server" onserverclick="_CustomEvent_ServerClick">
