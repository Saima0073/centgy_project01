...
<body>
    ...
    <form id="myForm" method="post" runat="server">
        ...
        <shma:DataGrid ID="EntryGrid" runat="server" Width="400px" ShowFooter="<%# ShowFooter %>" AutoGenerateColumns="False" HeaderStyle-CssClass="GridHeader">
    ...
    <script language="javascript"><asp:literal id="FooterScript" runat="server" EnableViewState="True"></asp:literal >
                function beforeSave() {
                    ...
                    for (j = 1; j <= totalRecords-1; j++) {
                        YN = document.getElementById('EntryGrid__ctl' + (j + 1) + '_ddlUCH_DEFAULT').value;
                        if (YN == 'Y')
                            counter++;
                    }
                    ...
                    NewDefault=document.getElementById('EntryGrid__ctl' + (totalRecords + 1) + '_ddlNewUCH_DEFAULT').value;
                    if (NewDefault=="Y") {
                        counter++;
                    }
                    if ((counter) > 1) {
        ...
        function selectAllCheckBoxes(obj) {
            for (j = 1; j <= totalRecords - 1; j++) {
                document.getElementById('EntryGrid__ctl' + (j + 1) + '_chkDelete').checked = obj;
    ...
    <table border="0" width="100%">
        <tr>
            <td align="right"><a class="button2" onclick="send()" href="#">Save</a> <a class="button2" onclick="deleteDetail()" href="#">Delete</a>
            <td align="right"></td>
        </tr>
    </table>
</body>
