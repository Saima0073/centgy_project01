    ...
    <div>
        ...
        <div id="NormalEntryTableDiv" class="NormalEntryTableDiv" runat="server" style="z-index: -111">
            <table id="entryTable" border="0" cellspacing="0" cellpadding="2">
                ...
                <tr id="rowNPH_TITLE" class="TRow_Normal">
                    <td id="lblddlNPH_TITLE" style="height: 23px" width="110" align="right">
                        Title
                    </td>
                    ...
                    <td id="lbltxtCNIC_VALUE" width="110" align="right">
                        <SHMA:DropDownList ID="ddlNPH_IDTYPE" TabIndex="3" Style="border-bottom: #444 0px solid;
                            border-left: #444 0px solid; border-top: #444 0px solid; border-right: #444 0px solid"
                    ...
                    <td id="lbltxtNPH_IDNO2" width="110" style="display: none" align="right">
                        Old N.I.C.
                    </td>
                ...
                <tr id="rowNPH_FULLNAME" class="TRow_Normal">
                    <td id="TDtxtNPH_FULLNAME" width="110" align="right">
                        Name in English
                    </td>
                    <td width="186">
                    ...
                    <td id="lbltxtNPH_FULLNAMEARABIC" width="110" align="right">
                        Name in Arabic
                    </td>
                ...
                <tr id="rowNPH_BIRTHDATE" class="TRow_Normal">
                    <td id="TDtxtNPH_BIRTHDATE" width="110" align="right">
                        Date of Birth
                    </td>
                    <td width="186">
                    ...
                    <td id="TDddlNPH_SEX" width="110" align="right">
                        Gender
                    </td>
                    <td width="186">
                ...
                <tr id="rowddlCOP_OCCUPATICD" class="TRow_Alt">
                    <td id="lblddlCOP_OCCUPATICD" width="110" align="right" style="vertical-align: top">
                        Occupation
                    </td>
            ...
            <td id="lblddlCCL_CATEGORYCD" width="110" align="right">
                Occupational&nbsp;Class
            </td>
            <td width="186">
            ...
            <tr id="rowHeightWeight" class="TRow_Normal" runat="server">
                <td style="height: 21px" id="TDtxtNU1_ACCOUNTNO1" width="110" align="right">
                    Height
                </td>
            ...
            <tr id="rowBMIAccount" class="TRow_Alt" runat="server">
                <td id="lbltxt_bmi" width="106" align="right">
                    BMI&nbsp;&nbsp;
                </td>
                ...
                <td id="lbltxtNU1_ACCOUNTNO" align="right" width="110">
                    Account No
                </td>
            ...
            <tr class="TRow_Normal">
                <td id="TDtxtNU1_ACCOUNTNO" width="110" align="right">
                    Smoker
                </td>
                <td width="186">
                ...
                <td id="lblddlBranch" align="right" width="110">
                    Branch
                </td>
            ...
            <tr class="TRow_Alt">
                <td width="106" align="right" id="lbltxtNPH_ANNUINCOME">
                    Yearly Income
                </td>
            ...
            <tr>
                ...
                <td id="TDtxtNU1_ACCOUNTNO3" width="110" align="right">
                </td>
                <td width="186">
            ...
            <tr id="rowNPH_INSUREDTYPE" class="TRow_Alt">
                <td id="TDddlNPH_INSUREDTYPE1" width="110" align="right">
                </td>
                <td width="186">
                    <p>
                  ...
                  <tr>
                 <td id="lblddlCNT_NATCD" style="height: 23px" align="right" width="106">
                    Nationality
                </td>
        ...
        <script language="javascript">
            ...
            function setViewSecondLife(val) {
                ...
                if (val == 'N') {
                    ...
                    parent.document.getElementById('shgn_ss_se_stdscreen_ILUS_ET_NM_PER_PERSONALDETINS').height =300; //135
                    parent.parent.document.getElementById('mainContentFrame').style.height = '800.0px'; //'460.0px';
                }
                else {
        ...
        <div id="boxes">
            <div id="dialog" class="window">
                <div width="100%">
                    <input type="button" value="Close" onclick="closeOccupationDialog();" style="position: relative;
                        right: 1px"></input>
