<%@ Page language="c#" Codebehind="PersonalPage_menue.aspx.cs" AutoEventWireup="True" Inherits="ACE.Presentation.PersonalPage_menue" %>
<HTML>
	<HEAD>
		<title>::
		...
		<script src="../shmalib/jscript/ClientUI/UIParameterization.js" type="text/JavaScript"></script>
		<script src="JSFiles/jquery-1.4.3.min.js" type="text/JavaScript"></script>
		...
		<script language="JavaScript">
			...
			function setPageByApplyingRules(img, screen)
			{
				...
				if ( (!isAdminType(userType)) && (screen == 'shgn_gp_gp_ILUS_TREE_ADMIN') )
				{
						alert('Navigation not allowed.');
						return false;
				}
			...
			//	alert(entityId);
				...
				{
					document.getElementById('mainContentFrame').style.height = '950.0px';
					setCurrentImage('imgPersonal');
					obj1 = document.getElementById("img2");
					obj1.src="images/Navigation/Plan.jpg";	
				}
				if (currentScreen=='shgn_gp_gp_ILUS_ET_GP_PERONAL2')
				{
					document.getElementById('mainContentFrame').style.height = '950.0px';
					setCurrentImage('imgPersonal');
					obj1 = document.getElementById("img2");
                ...
                if (currentScreen == 'shgn_gp_gp_ILUS_ET_GP_SutabilityAssessment') {
                    ...
                    obj1 = document.getElementById("img2");
                    obj1.src = "images/Navigation/Assessment.jpg";
                }
				...
				if(currentScreen=='ManualPolicyIssuanceOfPendingProposals_Group')
				{					
					document.getElementById('mainContentFrame').style.height = '450.0px';					
				}
				if(currentScreen=='ManualPolicyIssuanceOfPendingProposalsView_Group')
				{					
					document.getElementById('mainContentFrame').style.height = '450.0px';					
				}
				if(currentScreen=='ManualPolicyIssuanceSearch_Group')
				{					
					document.getElementById('mainContentFrame').style.height = '450.0px';					
				}
				if(currentScreen=='ManualPolicyIssuanceSearch_Group')
				...
				if(currentScreen=='TransferPolicy_Group')
				{
					document.getElementById('mainContentFrame').style.height = '600.0px';
				}
			}
	...
	<body leftmargin="0" topmargin="0" oncontextmenu="return false;" onkeydown="return cancelBack(0)">
		<!-- Busy Background -->
		<div id="graybackground-div"></div>
		<div id="message-div">
			<div>Processing data, please wait...<br>
				<img src="Images/progressBar/busy10.gif"></div>
		</div>
		<form id="Form1" method="post" runat="server">
			<input id="txtNP1_PROPOSAL" name="txtNP1_PROPOSAL" style="VISIBILITY: hidden"> <input id="txtRptName" name="txtRptName" style="VISIBILITY: hidden">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
										...
										<tr>
											<td height="80" valign="middle"><!-- #BeginLibraryItem "/Library/top.lbi" -->
												<table width="100%" border="0" cellpadding="0" cellspacing="0">
													<tr height="100">
														<td rowspan="2" width="17%"><IMG src="images/CompanyLogo.gif" border="0"></A> 
																		...
																		<table width="475" border="0" cellspacing="3" cellpadding="3">
																			...
																			<tr>
																				<td colspan="3" align="center" height="5">
																					<asp:label id="lblTestVersion" Runat="server" ForeColor="Gray" Font-Names="Verdana" Font-Size="XX-Small"
																	...
																	<td align="center" width="100%"> <!-- <td align="" width="100%"> -->
																		<table border="0" cellpadding="0" cellspacing="0"> <!-- align="center"  width="100%" -->
																			<tr>
																				...
																				<td width="1" align="center"><img id="assessmentDivider" src="images/divider.gif" width="1" height="25"  runat="server"></td>
							...
							<tr>
												...
												<table width="183" border="0" cellspacing="1" cellpadding="0" id="MenuTable">
													<tr>
														...
														<td width="183" rowspan="5" class="menu_button"><!-- #BeginLibraryItem "/Library/left.lbi" -->
															<table id="TABLE1" width="187" border="0" cellspacing="1" cellpadding="0" style="WIDTH: 187px; HEIGHT: 100%">
																<tr>
																	...
																	<td class="img__left_navigation_top_design" height="55">
																		<p class="loginuser">
																			User :
																			<asp:Literal id="_loggedUser" runat="server" EnableViewState="False"></asp:Literal>
																			<br>
																			<asp:Literal id="_loggedBranchLabel" runat="server" EnableViewState="False"></asp:Literal>
																			:
																			<asp:Literal id="_loggedBranch" runat="server" EnableViewState="False"></asp:Literal>
																		</p>
																	</td>
																</tr>
																<!-- 
																...
																-->
																<tr id="rptIllustration">
																	<td><a onClick="executeReport('ILLUSTRATION');" class="image" href="#">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Illustration 
																			Printing</a></td>
																</tr>
																<tr id="rptAdvice" style="DISPLAY:none">
																	<td id="TDhlkAdvice"><a onClick="executeReport('ADVICE');" class="image" href="#">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Advice 
																			Printing</a>
																	</td>
																</tr>
																<tr id="rptProfile">
																	<td><a onClick="executeReport('PROFILE');" class="image" href="#">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Personal 
																			Profile</a>
																	</td>
																</tr>
																<tr id="rptPolicy">
																	<td><A onClick="executeReport('POLICY');" class="image" href="#">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Policy 
																			Printing</A>
																	</td>
																</tr>
																<tr id="rptPersonalInfo">
																	<td><A onClick="executeReport('PROPOSALINQ');" class="image" href="#">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Proposal 
																			Inquiry</A>
																	</td>
																</tr>
																<tr>
																...
																-->
																<tr>
																	<td><a href="#" onClick="showProposalStatus();" class="image">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Proposals 
																			Status</a></td>
																</tr>
																<tr>
																	<td><a href="#" onClick="showUnApprovedProposal();" class="image">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Unapproved 
																			Proposals</a></td>
																</tr>
																<tr>
																	<td><a href="#" onClick="window.open('HelpFiles/BancassurancUsersGuide.pdf');" class="image">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;User 
																			Guide</a></td>
																</tr>
																<!--
																...
																<tr>
																	<td>
																		<a href="#" onClick="document.getElementById('imgLogoutButton').click();" class="image">
																			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Logout
															...
															<table width="187" border="0" cellspacing="1" cellpadding="0" style="WIDTH: 187px; DISPLAY: none; HEIGHT: 270px"
																id="UserManTable">
																<TBODY>
																	<tr>
																		<td class="img__left_navigation_top_design" height="55">
																			<p class="loginuser">
																				User :
																				<asp:Literal id="_loggedUser2" runat="server" EnableViewState="False"></asp:Literal>
																				<br>
																				<asp:Literal id="_loggedBranchLabel2" runat="server" EnableViewState="False"></asp:Literal>
																				:
																				<asp:Literal id="_loggedBranch2" runat="server" EnableViewState="False"></asp:Literal>
																			</p>
																		</td>
																	</tr>
																	<tr>
								...
								<td width="790" valign="top">
									<table cellSpacing="5" cellPadding="10" width="613" border="0" id="iframetab">
										<tr>
											<td width="790" valign="top">
												<table style="WIDTH: 613px; HEIGHT: 332px" cellSpacing="5" cellPadding="10" width="613"
													...
													<tr>
														<td vAlign="top" id="ifrTD">
															<!--file here...-->
															<DIV style="Z-INDEX: 1; POSITION: static; WIDTH: 800px; HEIGHT: 620px; OVERFLOW: auto"
																id="layer1" class="box1">
																<!--Your Working Area -->
																...
																<iframe id="mainContentFrame" frameborder="1" name="mainContentFrame" marginWidth="0" marginHeight="0"
																	src="../Presentation/shgn_ss_se_stdscreen_ILUS_ET_NM_WELCOME.aspx" width="655" scrolling="no"
																	height="620" style="WIDTH: 760px; HEIGHT: 300px"></iframe>
																<!--</fieldset>--></DIV>
														</td>
													</tr>
												</table>
	...
	function showProposalStatus(){
		setPage('ManualPolicyIssuanceSearch_Group');
	}
	...
	{		
		...
		if(isAdminType(userType) || userType =='S'){
